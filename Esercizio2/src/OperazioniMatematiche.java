...
public class OperazioniMatematiche {
	...
	public void cambiaSegno(Numero n) {
	...
	public void somma(Numero n1 , Numero n2) {
	...
	public void sottrazione(Numero n1 , Numero n2) {
		int num1 = n1.getNumeratore();     int num2 = n2.getNumeratore();
		int den1 = n1.getDenominatore();   int den2 = n2.getDenominatore();
	...
	public void moltiplicazione(Numero n1 , Numero n2) {
		int num1 = n1.getNumeratore();     int num2 = n2.getNumeratore();
		int den1 = n1.getDenominatore();   int den2 = n2.getDenominatore();
	...
	public void divisione(Numero n1 , Numero n2) {
		int num1 = n1.getNumeratore();     int num2 = n2.getNumeratore();
		int den1 = n1.getDenominatore();   int den2 = n2.getDenominatore();
